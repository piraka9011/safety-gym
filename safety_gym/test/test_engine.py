...
class TestEngine(unittest.TestCase):
    ...
    def test_flatten(self):
        ...
        cfg = EngineConfig(**{'observation_flatten': True})
        p = Engine(cfg)
        obs = p.reset()
        ...
        cfg = EngineConfig(**{'observation_flatten': False})
        p = Engine(cfg)
        obs = p.reset()
    ...
    def test_angle_components(self):
        ...
        cfg = EngineConfig(**{'robot_base': 'xmls/doggo.xml',
